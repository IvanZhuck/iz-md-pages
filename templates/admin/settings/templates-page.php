...
<div class="wrap">
    ...
    <p class="description" style="margin-top: 15px;">
        <?php esc_html_e('Configure Markdown output templates for each public post type. You can use the following placeholders:', 'iz-md-pages'); ?>
        <?php foreach ($supportedPlaceholders as $placeholder) : ?>
